...
def create_app(test_config=None):
    ...
    # Event sub-modules cut from the v1 scope (meal planning + sleeping). Built and
    # dormant; flip EVENT_EXTRAS=true to bring them back without a code change.
    app.config['EVENT_EXTRAS'] = os.environ.get('EVENT_EXTRAS', '').lower() == 'true'
